...
class PrivacyPages extends StatelessWidget {
  const PrivacyPages({Key key}) : super(key: key);
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          SettingRowWidget(
            "Precise location",
            subtitle:
                'Disabled \n\n\nIf enabled, megas will collect, store, and use your device\'s precise location, such as your GPS information. This lets megas improve your experience - for example, showing you mpre local content, ads, and recommendations.',
          ),
          HeaderWidget(
